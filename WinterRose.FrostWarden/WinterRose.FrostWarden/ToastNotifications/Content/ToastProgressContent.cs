...
public class ToastProgressContent : ToastContent
{
    ...
    public ToastProgressContent(float initialProgress = 0f, Func<float, float>? ProgressProvider = null, bool closesToastWhenComplete = true, string infiniteSpinText = "Working...")
    {
    ...
    public override float GetHeight(float width) => 30f;
    ...
    public override void Draw(Rectangle bounds, float contentAlpha)
    {
        ...
        Color bg = new Color(50, 50, 50, (int)(255 * contentAlpha));
        Color fill = new Color(100, 200, 255, (int)(255 * contentAlpha));
        ...
        ray.DrawText(progressText, (int)textX, (int)textY, fontSize, new Color(255, 255, 255, (int)(255 * contentAlpha)));
    }
