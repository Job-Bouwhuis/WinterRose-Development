...
public readonly struct AnonymousValue
{
    ...
    /// <summary>
    /// The value if it is a <see cref="AnonymousObjectReader"/> <br></br>
    /// 
    /// Allows for accessing deeper values in the object.
    /// </summary>
    public readonly AnonymousObjectReader? AnonymousObjectReaderValue => Value as AnonymousObjectReader;
    /// <summary>
    ...
    /// <summary>
    /// Allows for accessing the value if it is a <see cref="AnonymousObjectReader"/> and the value is not null.
    /// </summary>
    /// <param name="name"></param>
    /// <returns></returns>
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static implicit operator AnonymousObjectReader(AnonymousValue value) => value.AnonymousObjectReaderValue ?? throw new InvalidCastException("Value is not an AnonymousObjectReader");
