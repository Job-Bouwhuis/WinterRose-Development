    ...
    public override World CreateFirstWorld()
    {
        ...
        void ShowToast(ToastRegion r, ToastStackSide s)
        {
            ...
            Toast t = new Toast(ToastType.Info, r, s)
                    ...
                    .AddButton("show window normal", Invocation.Create<IUIContainer, UIButton>((c, b) => w.Show()))
                    .AddButton("show window collapsed", Invocation.Create<IUIContainer, UIButton>((c, b) => w.ShowCollapsed()))
                    .AddButton("show window maximized", Invocation.Create<IUIContainer, UIButton>((c, b) => w.ShowMaximized()))
                    .AddButton("close window", Invocation.Create<IUIContainer, UIButton>((c, b) => w.Close()))
                    .AddButton("close toast", Invocation.Create<IUIContainer, UIButton>((c, b) => c.Close()))
