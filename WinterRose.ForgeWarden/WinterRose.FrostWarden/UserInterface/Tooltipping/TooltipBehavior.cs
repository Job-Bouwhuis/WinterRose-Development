...
namespace WinterRose.ForgeWarden.UserInterface.Tooltipping
{
    public abstract class TooltipBehavior
    {
        ...
        /// <summary>
        /// Whether the tooltip should steal keyboard focus when opened
        /// </summary>
        ...
        /// </summary>
        public virtual bool ShouldOpen() => true;

        /// <summary>
        /// Called to decide if the tooltip should close for a given reason. Return false to block closing.
        /// </summary>
        public virtual bool ShouldClose(TooltipCloseReason reason) => true;
