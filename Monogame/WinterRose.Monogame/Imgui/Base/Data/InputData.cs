...
public class InputData
{
    ...
    public void Update(Game game)
    {
        ...
        io.DisplaySize = new Vector2(MonoUtils.Graphics.PresentationParameters.BackBufferWidth, MonoUtils.Graphics.PresentationParameters.BackBufferHeight);
    ...
    {
        MouseCursor mouseCursor = gui.GetMouseCursor() switch
        {
